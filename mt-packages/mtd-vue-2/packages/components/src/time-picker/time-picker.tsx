import {
  computed, defineComponent, markRaw, PropType, ref, useResetAttrs,
} from '@ss/mtd-adapter'
...
export default defineComponent({
  ...
  setup(props, ctx) {
    ...
    return {
      ...
      parseDate, m_open: open, setOpen, setInputValue,
      m_disabled, m_handleChange: formItemHook.m_handleChange,
      resetAttrs,
    }
  },
  computed: {
  ...
  methods: {
    ...
    emitOpen() {
      !this.m_open && this.setOpen(true)
    },
    emitClose() {
      this.m_open && this.setOpen(false)
    },
  ...
  render() {
    const {
      m_open, placement, m_disabled: disabled, appendToContainer, getPopupContainer, popperOptions, wrapperClasses,
      ...
      hideDisabledOptions, type, prefixCls, resetAttrs,
    } = this
    const Component = panel
    const InputComp = (type === 'timerange' ? RangeInput : TimePickerInput) as any
