...
export default defineComponent({
  ...
  emits: ['input', 'change', 'select-change', 'update:modelValue'],
  setup(props, { emit }) {
    ...
    const restProps = useResetAttrs(props)
  ...
  render() {
    ...
    const commonSlots = {
      default: getScopedSlotsInRender(this, 'default'),
      children: getScopedSlotsInRender(this, 'children'),
    }

    const leftPanelSlots = {
      ...commonSlots,
      footer: getSlotsInRender(this, 'leftFooter') ? () => getSlotsInRender(this, 'leftFooter') : undefined,
    }
    const rightPanelSlots = {
      ...commonSlots,
      footer: getSlotsInRender(this, 'rightFooter') ? () => getSlotsInRender(this, 'rightFooter') : undefined,
    }
    ...
    return <div class={prefix}>
      <transfer-panel
        ...
        v-slots={leftPanelSlots}
        {...vSlots(leftPanelSlots)}
      >
      </transfer-panel>
      ...
      <transfer-panel
        ...
        v-slots={rightPanelSlots}
        {...vSlots(rightPanelSlots)}
      >
      </transfer-panel>
    </div>
  },
