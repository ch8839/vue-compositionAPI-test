import { inject, computed, getAllScopedSlots } from '@ss/mtd-adapter'
...
export const useTree = (props: TreeNodeProps) => {
  ...
  const treeSlots = computed(() => getAllScopedSlots(tree))
  ...
  const changeOnSelect = computed(() => !!tree.changeOnSelect)
