...
import {
  defineComponent, computed, ref, watch, classNames, styles,
  getListeners, useResetAttrs, useListeners, toProps, getScopedSlotsInRender,
} from '@ss/mtd-adapter'
  ...
  render() {
    ...
    >
      {multiple ? <mtd-multiple
        ...
        maxCount={maxCount}
        closable={closable}
        tipMaxCount={tipMaxCount}
        collapseTags={collapseTags}
        {...restMultipleListeners}
        renderTag={getScopedSlotsInRender(this, 'tag')}
        {...restAttrs}
      /> : <mtd-single
        {...props}
        ref='singleRef'
