...
/* const MtdCollapseTransition = (props: any, { slots }: any) => {
  ...
  const resetListeners = useListeners(MTDTransition)
  return h('transition', { ...myProps.value, ...resetListeners.value }, slots)
}
...
export default defineComponent({
  ...
  setup(props, ctx) {
    ...
    return {
      resetAttrs, resetListeners,
    }
  },
  render() {
    const { resetAttrs, resetListeners } = this
