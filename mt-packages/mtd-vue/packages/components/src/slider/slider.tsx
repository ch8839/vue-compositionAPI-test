  ...
  setup(props, { emit }) {
    ...
    const wrapperClass = computed(() => {
      return [
        ...
        [
          {
            [`${prefix.value}-disabled`]: props.disabled,
    ...
    function getPercent(value: number, _b?: number) {
      const begin: number = _b === undefined ? props.min : _b
    ...
    function setValue(offset: number, type?: number) {
      ...
      ins.$set(state.internalValue, index, value)
    }
    ...
    const methodsCollection = {
      handleClick, getPercent, handleChange, handleButtonDragging, handleDragEnd, handleDragRangeButtonStart,
    }
