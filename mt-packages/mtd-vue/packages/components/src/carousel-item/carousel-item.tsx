...
export default defineComponent({
  ...
  setup(props) {
    ...
    const prefixCarousel = computed(() => config.getPrefixCls('carousel'))
    ...
    return {
      prefix, prefixCarousel, itemStyle, position, itemRef, handleAnimationend, setAnimation,
    }
  },
  render() {
    const {
      prefix, prefixCarousel, itemStyle, cardType,
      index, activeIndex, fake, position, mask,
    } = this
