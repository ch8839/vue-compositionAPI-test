...
import { computed, defineComponent, reactive, ref, toRefs, classNames, styles } from '@ss/mtd-adapter'
...
export default defineComponent({
  ...
  setup(props, ctx) {
    ...
    const dateTableAttrs = useAttrs(ctx.attrs)
  ...
  render() {
    ...
    return <div
      ...
      <div class={[prefixCls + '-body']}>
        ...
        {(confirm || type === 'datetimerange') && <Confirm
        ...
        >
          {$slots.footer}
          {/*  <template v-slot v-if="$slots.footer">
            <slot name="footer" />
          </template> */}
        </Confirm>}
      </div>
