...
export const useControl = (props: any, ctx: any) => {
  ...
  return {
    _checkedKeys: checkedKeys, setCheckedKeys,
    _selectedKeys: selectedKeys, setSelectedKeys,
    _expandedKeys: expandedKeys, setExpandedKeys,
    _loadedKeys: loadedKeys, setLoadedKeys,
    checkedKeyMap,
    expandedKeyMap,
    loadedKeyMap,
    selectedKeyMap,
