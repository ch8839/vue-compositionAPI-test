...
export default defineComponent({
  ...
  setup(props, ctx) {
    ...
    const datetimerangeState = {
      ...
      m_splitPanels: computed(() => props.type === 'datetimerange' || props.splitPanels),
    }
  ...
  methods: {
    ...
    setPanelDates(leftPanelDate: Dayjs) {
      ...
      if (this.type !== 'datetimerange') {
        ...
        this.rightPanelDate = this.m_splitPanels && this.value[1]
  ...
  render() {
    ...
    const CompPanel = isWeek ? DatePickerWeekPanel : DatePickerPanel
