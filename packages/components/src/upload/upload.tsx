...
export default defineComponent({
  ...
  render() {
    ...
    const trigger = getSlotsInRender(this, 'trigger') || getSlotsInRender(this)
    ...
    return (
      <div>
        ...
        {getSlotsInRender(this, 'trigger')
          ? [uploadComponent, getSlotsInRender(this)]
          : uploadComponent
        }
        {getSlotsInRender(this, 'tip')}
