...
export default defineComponent({
  ...
  emits: ['focus', 'input', 'change', 'blur', 'focusLeft', 'focusRight',
    'click-prefix', 'click-suffix', 'clear', 'enter',
  ],
  setup(props, { attrs, emit, slots }) {
    ...
    // use from
    const m_invalid = computed(() => props.invalid)
    ...
    const resetListenersLeft = useListeners({
      input: handleInput('left'),
      keyup: handleKeyup,
      blur: handleBlur,
      focus: handleFocus('left'),
    }, ['focus', 'input', 'change', 'blur'])
    const resetListenersRight = useListeners({
  ...
  render() {
    ...
    const {
      ...
      disabled, readonly, noReadonlyClass, m_invalid,
      size, placeholder,
    ...
    return <div
      class={classNames(this, {
        ...
        [`${prefixInput}-group`]: getSlotsInRender(this, 'prepend') || getSlotsInRender(this, 'append'),
        [`${prefixInput}-disabled`]: disabled,
        [`${prefixInput}-readonly`]: !noReadonlyClass && readonly,
        [`${prefixInput}-invalid`]: m_invalid,
    ...
    >
      ...
      {hasPrefix &&
        <span class={`${prefixInput}-prefix-inner`}>
          {getSlotsInRender(this, 'prefix') || <i class={prefixIcon} onClick={handlePrefixClick} />}
        </span>
      }
